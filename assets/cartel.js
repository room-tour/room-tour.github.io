...
const Gala = '<h1 class="artsname">Gala Hernández López</h1>' +
              ...
              '<img id="fleury" class="responsiveI" src="./Data/gala.png">'+ 
              ...
              '<a href="https://www.galahernandez.com/en/proyectos/moon/" target="_blank"><button id="myButton" class="center-button">VISIT WORK</button></a>' +
...
const Nicolas = '<h1 class="artsname">Nicolas Bailleul</h1>' +
                ...
                '<p>Through the creation of documentary films, installations, and performances, The work of Nicolas Bailleul is defined by the use, appropriation, collection, and exploration of platforms, virtual worlds, connected spaces, and the web s uncertain logics and geographies. By attempting to concretely depict what unfolds in supposedly unreal, invisible, and inaccessible places, NB aims to bring forth contemporary issues related to creation, sociology, economy, and ecology. Graduated from the Haute école des Arts du Rhin (Strasbourg) and with a Master s 2 degree in Anthropological and Documentary Cinema (Paris Nanterre). Since October 2020, PHD candidate at the AIAC laboratory (University Paris 8).</p>'+
                '<a href="https://simmer.io/@icContemporary/uniform" target="_blank"><button id="myButton" class="center-button">VISIT WORK</button></a>' +
                '<p>Installation, Web interface The video installation "RGB Tour" is an evolving HTML page that accumulates an increasing number of video excerpts from room tours (an extremely popular practice that consists of a filmed guided tour of the creator s room), listed and downloaded using a program that transforms specific sequences of YouTube videos into animated GIFs lasting 5 to 10 seconds. Each downloaded excerpt is categorized in the grid of the page based on the objects that appear in the image and the resulting lighting atmospheres. It is a collaborative and evolving work that will eventually become a procedurally generated film, an endless room tour whose editing will be orchestrated by an algorithm that associates images, objects, and colors.</p>';
