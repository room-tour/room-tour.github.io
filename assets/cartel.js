...
const Gala = '<h1 class="artsname">Gala Hernández López</h1>' +
              ...
              '<p>"Reality shifting" is a practice that became popular among adolescents and young people in the #shiftok universe on TikTok at the beginning of the COVID-19 pandemic. It consists of reaching an altered state of consciousness through different exercices — meditation, self-hypnosis, writing a script, repeating "affirmations", music — that allows you to espace from your current reality (CR, Current Reality). The desired reality is usually te world of a pre-existing fiction such as Harry Potter or Narnia, in which the person whishes to live. Adopting the form of a tutorial, the performance will expose the different methods at our disposal to build our desired reality in digital capitalism. What is a desired reality, hyper-adapted to the subject that inhabits it? What fictions do we live in? Whats does the "reality shifting" tell us about a society increasingly terrified of risk, conflict and dissensions and immersed in a fantasy of security and individual omnipotence without limits?</p>'+
              '<a href="https://www.youtube.com/watch?v=yTgvRGQ_750" target="_blank"><button id="myButton" class="center-button">VISIT WORK</button></a>' +
